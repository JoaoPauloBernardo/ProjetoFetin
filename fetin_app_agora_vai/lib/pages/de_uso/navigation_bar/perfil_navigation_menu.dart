...
class NavigationMenuPerfil extends StatefulWidget {
  final int? swtichIndex;

  const NavigationMenuPerfil({
    super.key,
    this.swtichIndex, 
    });
...
class _NavegationMenuState extends State<NavigationMenuPerfil> {
  int _selectedIndex = 2; //! Quando adicionar o calendario novamente colocar index 3 
  final _screens = [
    const HomePage(),
